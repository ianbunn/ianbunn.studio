...
if (isset($_GET['mail'])) {
  ...
  $smtp_host        = 'smtp.resend.com';                    // Enter the smtp server address you got from your hosting here
  $smtp_port        = 465;                                 // TCP port to connect to
  $smtp_username    = 'resend';           // SMTP username
  $smtp_password    = 're_DzpX5o4t_BtkCkZZLWT8BAKdPgZpHzDjy';                        // SMTP password
      ...
      try {
         ...
         $mail->addAddress("ian@ianbunn.studio");            // Enter the email address you want to send here
